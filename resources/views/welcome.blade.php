...
<head>
    ...
    //detect if the visitor is a webscraper, if so, don't allow the visitor to view the website
...
<main>
    <article>
        ...
        <div class="p3 text-secondary">
            Student at <a class="text-neutral text-hover-primary" href="https://www.rijnijssel.nl/" target="_blank">RijnIJssel</a>
        </div>
